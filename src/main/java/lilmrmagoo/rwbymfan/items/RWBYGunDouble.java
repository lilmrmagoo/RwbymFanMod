...
public class RWBYGunDouble extends ItemBow implements ICustomItem{
    ...
    public RWBYGunDouble setElement(String element) {
        this.element = element;
        return this;
    }

    public RWBYGunDouble setElementMelee(String elementmelee) {
        this.elementmelee = elementmelee;
        return this;
    }

    public RWBYGunDouble setRecoil(int shotrecoil) {
    ...
    * */
    ...
    public RWBYGunDouble(String name, int durability, int weapondamage, int weapontype, String data, String morph, String ammo, boolean noCharge, float projectileSpeed, boolean shield, boolean canBlock, int recoilType, int bulletCount, int enchantmentglow, int soundeffect, CreativeTabs creativetab) {
