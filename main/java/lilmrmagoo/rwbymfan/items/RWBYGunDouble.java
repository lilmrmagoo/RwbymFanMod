...
public class RWBYGunDouble extends ItemBow implements ICustomItem{
    ...
    public RWBYGunAddon setElement(String element) {
        this.element = element;
        return this;
    }

    public RWBYGunAddon setElementMelee(String elementmelee) {
        this.elementmelee = elementmelee;
        return this;
    }

    public RWBYGunAddon setRecoil(int shotrecoil) {
    ...
    * */
    ...
    public RWBYGunAddon(String name, int durability, int weapondamage, int weapontype, String data, String morph, String ammo, boolean noCharge, float projectileSpeed, boolean shield, boolean canBlock, int recoilType, int bulletCount, int enchantmentglow, int soundeffect, CreativeTabs creativetab) {
